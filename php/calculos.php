...
if (!($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['figura']))) {
    ...
    switch ($figura) {
        ...
        case 'Trapecio':
            ...
            $_SESSION['base_mayor'] = $base_mayor;
            $_SESSION['base_menor'] = $base_menor;
            $_SESSION['altura'] = $altura;

            $trapecio = new Trapecio($base_mayor, $base_menor, $altura);
            $resultados['area'] = $trapecio->calcularArea();
            $resultados['perimetro'] = $trapecio->calcularPerimetro();
            break;
