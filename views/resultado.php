...
if ($figura !== 'Cuadrado') {
    echo "<h1>Error</h1>";
    echo "<p>La figura seleccionada no es un cuadrado. Asegúrate de utilizar el formulario para cuadrado.</p>";
    exit;
}
?>
...
<body>
    <div class="container">
        ...
        <div class="results-container">
            <p>Lado: <?php echo htmlspecialchars($_SESSION['lado1_cuadrado']); ?></p>
